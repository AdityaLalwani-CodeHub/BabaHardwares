 ...
 * @author Aditya
 */
public class MANAGE_CUSTOMER_CATEGORIES_FORM extends javax.swing.JFrame {
    ArrayList<CustomerCategory> list;
    /**
     * Creates new form MANAGE_CUSTOMER_CATEGORIES_FORM
     */
    public MANAGE_CUSTOMER_CATEGORIES_FORM() {
        initComponents();
        try {
            list = Myfunc.getCustomerCategoryList();
        } catch (SQLException ex) {
            Logger.getLogger(MANAGE_CUSTOMER_CATEGORIES_FORM.class.getName()).log(Level.SEVERE, null, ex);
            JOptionPane.showMessageDialog(null,"Unable to Load Customer categories in the table : " + ex.getMessage());
            this.dispose();
        }
        Show_Customer_Category_in_JTable();

    }

    private void Show_Customer_Category_in_JTable(){
        DefaultTableModel model = (DefaultTableModel)jTable_customerCategory.getModel();
    ...
    private void initComponents() {
        ...
        jTable_customerCategory = new javax.swing.JTable();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("CUSTOMER CATEGORIES");
        ...
        jTable_customerCategory.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jTable_customerCategory.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTable_customerCategoryMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(jTable_customerCategory);
    ...
    private void jButton_nextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_nextActionPerformed
        ...
        int index = jTable_customerCategory.getSelectedRow();
        //System.out.println(index);
/*        ArrayList<CustomerCategory> catList;
        try {
            catList = Myfunc.getCustomerCategoryList();
        } catch (SQLException ex) {
            Logger.getLogger(MANAGE_CUSTOMER_CATEGORIES_FORM.class.getName()).log(Level.SEVERE, null, ex);
            JOptionPane.showMessageDialog(null, "Problem fetching the Customer Category List : " + ex.getMessage());
            return;
        }*/
        if(index >= 0 && index < (jTable_customerCategory.getRowCount()-1))
        {
            index++;
            jTable_customerCategory.setRowSelectionInterval(index, index);
            CustomerCategory category = list.get(index);
...
/*        ArrayList<CustomerCategory> catList;
        ...
        if(index > 0 && index < jTable_customerCategory.getRowCount())
        {
            index--;
            jTable_customerCategory.setRowSelectionInterval(index, index);
            CustomerCategory category = list.get(index);
    ...
    private void jButton_insertNewCategoryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_insertNewCategoryActionPerformed
        ...
        if(checkInputs())
        {
            ...
            try {
                ...
                ps = con.prepareStatement("INSERT INTO customer_category(id,Name)"
                    + "values(?,?) ");
                ps.setString(1, IDGenerator.getIDforCustomerCategory());
                ...
                con.close();
                 ...
                 JOptionPane.showMessageDialog(null,"ADDING CUSTOMER CATEGORY FAILED : " + ex.getMessage());
                try {
                    if(con != null) {
            ...
            }finally
            {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "Customer Category List could Not Be Refreshed : " + ex.getMessage());
                    this.dispose();
                }
            }
        }else{
    ...
    private void jButton_updateSelectedCategoryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_updateSelectedCategoryActionPerformed
        ...
        if(checkInputs())
        {
            int i = JOptionPane.showConfirmDialog(null, "UPDATING the CUSTOMER CATEGORY! ARE YOU SURE??", "WARNING",JOptionPane.YES_NO_OPTION );
            if(i != 0) return;      //NO
            Connection con = null;
            PreparedStatement ps = null;
            Savepoint savepoint1 = null;
            ...
            try {
                ...
                ps = con.prepareStatement("UPDATE customer_category SET Name = ? "
                    + " WHERE id = ?");
                ...
                con.close();
                 ...
                 JOptionPane.showMessageDialog(null,"UPDATING CUSTOMER CATEGORY FAILED : " + ex.getMessage());
                try {
                    if(con != null) {
                        con.rollback(savepoint1);
                    }
    ...
    private void jButton_deleteSelectedCategoryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_deleteSelectedCategoryActionPerformed
        ...
        {
            int i = JOptionPane.showConfirmDialog(null, "DELETING the CUSTOMER CATEGORY! ARE YOU SURE??", "WARNING",JOptionPane.YES_NO_OPTION );
            if(i != 0) return;      //NO
            Connection con = null;
            PreparedStatement ps = null;
            Savepoint savepoint1 = null;
            try {
                ...
                ps = con.prepareStatement("DELETE FROM customer_category WHERE id = ?");
            ...
            JOptionPane.showMessageDialog(null, "CUSTOMER CATEGORY Not Deleted : No ID To Delete");
        }
    }//GEN-LAST:event_jButton_deleteSelectedCategoryActionPerformed

    private void jTable_customerCategoryMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable_customerCategoryMouseClicked
        // TODO add your handling code here:
        int index = jTable_customerCategory.getSelectedRow();
/*        ArrayList<CustomerCategory> catList = null;
        try {
            ...
            Logger.getLogger(MANAGE_CUSTOMER_CATEGORIES_FORM.class.getName()).log(Level.SEVERE, null, ex);
            JOptionPane.showMessageDialog(null, "Problem Fetching data : " + ex.getMessage());
            return;
        }
        ...
        jTextField_id.setText(category.getId());
        jTextField_name.setText(category.getName());
    }//GEN-LAST:event_jTable_customerCategoryMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MANAGE_CUSTOMER_CATEGORIES_FORM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new MANAGE_CUSTOMER_CATEGORIES_FORM().setVisible(true);
        });
    }
    ...
    private javax.swing.JTable jTable_customerCategory;
